...
df = pd.read_csv("electromenagers_boulanger.csv")
...
df["Avis"] = df["Avis"].fillna("Appareil high Tech")
df["Avis"] = df["Avis"].replace("Avis non disponible", "Appareil high Tech")
...
df.to_csv("electromenagers_boulanger_cleaned.csv", index=False)
