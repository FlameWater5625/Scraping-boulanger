...
def fetch_data():
    conn = connect_db()
    query = "SELECT type_ordinateur, marque, modele, note, avis, prix FROM boulanger_ordinateurs_clean"
...
def visualize_ordi():
    ...
    # 🔹 4. Bar chart des ordi les mieux notées

    # Filtrer les consoles ayant au moins 50 avis
    ...
    plt.title("Top des ordis les mieux notées (min 10 avis)")
    plt.xlabel("Note")
    plt.ylabel("Modèle")
